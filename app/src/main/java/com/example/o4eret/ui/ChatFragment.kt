...
class ChatFragment : Fragment(R.layout.fragment_chat) {
    ...
    private fun renderPanel() {
        ...
        panelText.text = TerminalUi.asciiBox("CHAT", lines, width = 30)
    ...
    companion object {
        private const val KEY_STATUS = "chat_status"
        private const val KEY_ACTION = "chat_action"
        private const val READY = "READY"
        private const val WORKING = "WORKING"
        private const val ACTION_READY = "CONNECT"
        private const val ACTION_WORKING = "CONNECTING"
